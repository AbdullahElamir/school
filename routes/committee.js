...
router.put('/examCommittee/students/:id',userHelpers.isLogin,userHelpers.isAdmin , function(req, res) {
  CommitteeMgr.updateStudents(req.params.id,req.body,function(re){
    res.send(re);
  });
});

router.put('/examCommittee/proctors/:id',userHelpers.isLogin ,userHelpers.isAdmin, function(req, res) {
...
router.get('/examCommittee/get/students/:id',userHelpers.isLogin,userHelpers.isAdmin , function(req, res) {
...
router.get('/examCommittee/get/proctors/:id',userHelpers.isLogin,userHelpers.isAdmin , function(req, res) {
...
router.post('/examCommittee/add', userHelpers.isLogin,userHelpers.isAdmin ,function(req, res) {
...
router.delete('/examCommittee/delete/:id',userHelpers.isLogin,userHelpers.isAdmin , function(req, res) {
...
router.put('/examCommittee/edit/:id',userHelpers.isLogin ,userHelpers.isAdmin, function(req, res) {
...
router.get('/examCommittee/:searchValue/:limit/:page/:id_of_committee',userHelpers.isLogin ,userHelpers.isAdmin, function(req, res) {
...
router.get('/examCommittee//:limit/:page/:id_of_committee',userHelpers.isLogin ,userHelpers.isAdmin, function(req, res) {
